...
* Make backups of the 2st 27C16 EEPROM's and write into 28C16 or 27C16 proms
...
* Read out id from the PROMS  "firestarter id"
* Read out data from the PROMS  "firestarter read AM27C16 chip1.hex"
* Read out data from the PROMS  "firestarter write CAT28C16AI chip1.hex"
